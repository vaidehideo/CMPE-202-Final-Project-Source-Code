...
public class Main extends SimpleApplication implements AnimEventListener{
    ...
    public void simpleUpdate(float tpf) {
        ...
        if(mf==0 && cr==0 && cs==0)
        guiNode.attachChild(Quarter);
        text.setText("Blue Gumball!\tChange is " + change + "\tGumbslls left: " + numberOfGumballs);        
        ...
        f=0;
         ...
         if(mf==0 && cr==0 && cs==0)
         guiNode.attachChild(Quarter);
        text.setText("Green Gumball!\tChange is " + change + "\tGumbslls left: " + numberOfGumballs);        
        guiNode.attachChild(text);
        rootNode.attachChild(alien);   
        ...
        if(mf==0 && cr==0 && cs==0)
        guiNode.attachChild(Quarter);
        text.setText("Red Gumball!\tChange is " + change + "\tGumbslls left: " + numberOfGumballs);        
        guiNode.attachChild(text);
        ...
        if(f==4){
            ...
            if(mf==0 && cr==0 && cs==0)
            guiNode.attachChild(Quarter);
            text.setText("Yellow Gumball!\tChange is " + change + "\tGumbslls left: " + numberOfGumballs);        
            guiNode.attachChild(text);
